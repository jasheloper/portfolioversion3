            ...
            <div className="project-info description">
             ...
             Portfolio site built solely for the purpose of displaying my work in web development, writing, and content creation.  A tool that is utilized for professional networking with others in the software (or similiar) fields including employers & a centralized location to share my knowledge and what I'm learning.
              ...
              <h4>
                ...
                <a href="https://jashele.dev/" target="_blank">View Demo</a> -  <a href="https://github.com/jasheloper/portfolioversion3" target="_blank">GitHub Code</a>
          ...
          <div className="single-project">
            ...
            <div className="project-info description">
              ...
              <h4>
                ...
                <a href="https://what-should-i-eat.netlify.com/" target="_blank">View Demo</a> -  <a href="https://github.com/jasheloper/React-Redux-App/tree/jashele-tillman" target="_blank">GitHub Code</a>
          ...
          <div className="single-project">
            ...
            <div className="project-info description">
              ...
              <h4>
                ...
                <a href="https://jasheletv.netlify.com/" target="_blank">View Demo</a> -  <a href="https://github.com/jasheloper/jashele-tv" target="_blank">GitHub Code</a>
